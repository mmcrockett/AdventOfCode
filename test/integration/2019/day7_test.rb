...
class Day7Test < ActiveSupport::TestCase
  ...
  describe "part 2" do
    ...
    describe "example3" do
      ...
      it "works" do
        assert_equal(139_629_729, run_it)
      end
    end
    ...
    describe "solution" do
      ...
      it "works" do
        assert_not_equal(24_905_296, run_it)
        assert_not_equal(49_810_592, run_it)
        assert_equal(49_810_599, run_it)
      end
    end
  end
end
